package com.example.kk.arttraining.pay.alipay;
 ...
 * 说明:
 */
public class AlipayFragment extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lerun_enroll_payment);
...
//                        payresult = payResult.getResult();
    ...
    public void pay() {
        ...
        //订单信息
        String orderInfo = getOrderInfo("" + "(卡乐体育)", "", "0.01");
        ...
        Runnable payRunnable = new Runnable() {
            ...
            public void run() {
                // 构造PayTask 对象
                PayTask alipay = new PayTask(AlipayFragment.this);
                // 调用支付接口，获取支付结果
    ...
    public void getSDKVersion() {
        PayTask payTask = new PayTask(AlipayFragment.this);
    ...
    private String getOrderInfo(String subject, String body, String price) {
        ...
        // 服务器异步通知页面路径
        orderInfo += "&notify_url=" + "\"" + Config.URL_PAY_ASYNC + "\"";
