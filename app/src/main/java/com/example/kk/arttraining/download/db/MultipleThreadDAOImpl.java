package com.example.kk.arttraining.download.db;
 ...
 * use for 数据访问接口实现
 */
public class MultipleThreadDAOImpl implements MultipleThreadDAO {

    private static final String TAG = "ThreadDAOImpl";

    private MultipleDBHelper myDBHelper2;

    public MultipleThreadDAOImpl(Context context) {
        this.myDBHelper2 = MultipleDBHelper.getInstancere(context);
    }
