 ...
 */
public class ThemeTeacher3 extends Activity implements ITeacherSearch, PullToRefreshLayout.OnRefreshListener {
    TeacherSearch3Data teacherSearchData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teacherSearchData = new TeacherSearch3Data(this);
    ...
    private class TeacherListItemClick implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            Intent intent = new Intent(ThemeTeacher3.this, ThemeTeacherContent.class);
