...
/**
 * 作者：wschenyongyin on 2016/10/19 09:13
 * 说明:重写RequestBody实现上传进度显示
 */
public class UploadFileRequestBody extends RequestBody {

    private RequestBody mRequestBody;
    private UploadListener mProgressListener;

    private BufferedSink bufferedSink;


    public UploadFileRequestBody(File file, UploadListener progressListener) {
    ...
    private Sink sink(Sink sink) {
        return new ForwardingSink(sink) {
            ...
            public void write(Buffer source, long byteCount) throws IOException {
                ...
                //回调上传接口
                mProgressListener.uploadListener(bytesWritten, contentLength, bytesWritten == contentLength);
            }
        };
    }
}