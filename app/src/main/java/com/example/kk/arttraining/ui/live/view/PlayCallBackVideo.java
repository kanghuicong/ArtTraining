...
import com.example.kk.arttraining.media.recodevideo.Utils;
...
public class PlayCallBackVideo extends VideoPlayerBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.live_playback_video_layout);
    ...
    private void showToastTips(final String tips) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mToast = Toast.makeText(PlayCallBackVideo.this, tips, Toast.LENGTH_SHORT);
                mToast.show();
            }
        });
    }
    ...
    protected Handler mHandler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (!LiveUtil.isNetworkAvailable(PlayCallBackVideo.this)) {
                sendReconnectMessage();
                return;
            }
