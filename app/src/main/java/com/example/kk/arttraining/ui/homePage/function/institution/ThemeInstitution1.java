 ...
 */
public class ThemeInstitution1 extends Activity implements IInstitutionList,PullToRefreshLayout.OnRefreshListener{
...
//        ThemeInstitutionUntil.themeInstitutionUntil(this,lvInstitution,"");
    ...
    public void getInstitutionList(final List<OrgBean> orgBeanList1) {
        ...
        adapter = new InstitutionFragmentAdapter(ThemeInstitution1.this, orgBeanList);
        ...
        lvInstitution.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ThemeInstitution1.this, ThemeInstitutionContent.class);
