 ...
 */
public class ThemeInstitution4 extends Activity implements IInstitutionList,PullToRefreshLayout.OnRefreshListener{
...
//        ThemeInstitutionUntil.themeInstitutionUntil(this,lvInstitution,"");
    ...
    public void getInstitutionList(final List<OrgBean> orgBeanList1) {
        ...
        adapter = new InstitutionFragmentAdapter(ThemeInstitution4.this, orgBeanList);
        ...
        lvInstitution.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ThemeInstitution4.this, ThemeInstitutionContent.class);
