 ...
 */
public class ThemeTeacher4 extends Activity implements ITeacherSearch, PullToRefreshLayout.OnRefreshListener {
    TeacherSearch4Data teacherSearchData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teacherSearchData = new TeacherSearch4Data(this);
    ...
    private class TeacherListItemClick implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            Intent intent = new Intent(ThemeTeacher4.this, ThemeTeacherContent.class);
