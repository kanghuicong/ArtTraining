 ...
 */
public class ThemeTeacher2 extends Activity implements ITeacherSearch, PullToRefreshLayout.OnRefreshListener {
    TeacherSearch2Data teacherSearchData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teacherSearchData = new TeacherSearch2Data(this);
    ...
    private class TeacherListItemClick implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            Intent intent = new Intent(ThemeTeacher2.this, ThemeTeacherContent.class);
