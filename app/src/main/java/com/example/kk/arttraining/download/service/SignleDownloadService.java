 ...
 * use for  单线程 下载服务
 */
public class SignleDownloadService extends Service {
    ...
    private SignleDownloadTask mDownloadTask = null;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_INIT:
                    ...
                    //启动下载任务
                    mDownloadTask = new SignleDownloadTask(SignleDownloadService.this, fileinfo);
