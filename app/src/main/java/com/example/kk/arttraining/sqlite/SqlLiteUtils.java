...
public class SqlLiteUtils extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table uploadTable(uid int,file_path varchar (200),order_id varchar(30),progress int,type varchar(20),create_time varchar(20),order_title varchar(30),order_pic varchar(50),att_size varchar(20),att_length varchar(20),pay_type varchar(20),att_type varchar(20),is_uploading int,is_pay int)");
