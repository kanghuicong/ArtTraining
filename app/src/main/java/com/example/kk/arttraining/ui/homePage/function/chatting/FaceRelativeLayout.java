...
public class FaceRelativeLayout extends RelativeLayout implements
	...
	public void onClick(View v) {
		...
		case R.id.btn_face:
			...
			break;
		case R.id.et_dynamic_content_comment:
			// 隐藏表情选择框
			if (view.getVisibility() == View.VISIBLE) {
				view.setVisibility(View.GONE);
			}
	...
	private void Init_View() {
		...
		et_sendmessage = (EditText) findViewById(R.id.et_dynamic_content_comment);
	...
	private void Init_viewPager() {
		...
		UIUtil.showLog("Face-emojis", emojis.size()+"---");
		for (int i = 0; i < emojis.size(); i++) {
			UIUtil.showLog("Face", "Face1");
	...
	private void Init_Data() {
		vp_face.setAdapter(new ChattingViewPagerAdapter(pageViews));
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (emoji.getId() == R.drawable.chatting_del_icon) {
