 ...
 * use for 数据访问接口实现
 */
public class SignleThreadDAOImpl implements SignleThreadDAO {

    private static final String TAG = "ThreadDAOImpl";

    private SignleDBHelper myDBHelper;

    public SignleThreadDAOImpl(Context context) {
        this.myDBHelper = new SignleDBHelper(context);
    }
