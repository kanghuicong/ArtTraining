...
public class ProductionChooseImage extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Config.ProductionImageList == null) {
            Config.ProductionImageList = new ArrayList<String>();
        } else {
            num = Config.ProductionImageList.size();
        }

        filelist = Config.ProductionImageList;
    ...
    public ImageView iconImage(final String filepath, int index, CheckBox checkBox)
        ...
        imageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductionChooseImage.this, ShareDynamicImage.class);
                ...
                try {
                    ...
                    if (imageView != null) {
                        ...
                        if (Num < 3) {
                            ...
                            checkBox.setChecked(false);
                            Toast.makeText(ProductionChooseImage.this, "最多只能选3张图片",
...
//        bundle.putString("type","image");
        bundle.putStringArrayList("files", Config.ProductionImageList);
...
//        startActivity(intent);
    ...
    public void onBackPressed() {
        Config.ProductionImageList.removeAll(cancelList);
        startActivity(new Intent(ProductionChooseImage.this, ProductionImgFileList.class));
        finish();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_cancel:
                Config.ProductionImageList = filelist;
                Config.ProductionImageList.removeAll(cancelList);
                sendfiles();
                break;
